...
<body style="width: 100vw; height: 640px">
  <div style="margin:10px auto; width: 375px; height: 838px; border: 2px solid #999; overflow:hidden">
    ...
    <div style="margin:10px auto; width: 80%; font-size:medium">
      ...
      <a href="https://www.aliyundrive.com/s/ww5BHwLnszw" style="text-decoration:none;">
      <strong style="color: skyblue;">https://www.aliyundrive.com/s/ww5BHwLnszw</strong>
    </a>
